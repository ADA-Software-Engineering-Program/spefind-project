  ...
  return (
    <div className='bookme'>
      ...
      <div className='bookme-container'>
            ...
            <div className='schedule-block'>
              ...
              <div className='schedule-cont'>
                ...
                <div className='schedule-time'>
                  <div>
                    <HiOutlineLocationMarker className='schedule-icon' /> jogor centre
                  </div>
                  <div>
          ...
          <div className='schedule-container'>
            <div className='schedule-block'>
              ...
              <div className='schedule-cont'>
                ...
                <div className='schedule-time'>
                  <div>
                    <HiOutlineLocationMarker className='schedule-icon' /> polin place
                  </div>
                  <div>
          ...
          <div className='schedule-container'>
            <div className='schedule-block'>
              ...
              <div className='schedule-cont'>
                ...
                <div className='schedule-time'>
                  <div>
                    <HiOutlineLocationMarker className='schedule-icon' /> st. Lora
                  </div>
                  <div>
          ...
          <div className='schedule-container'>
            <div className='schedule-block'>
              ...
              <div className='schedule-cont'>
                ...
                <div className='schedule-time'>
                  <div>
                    <HiOutlineLocationMarker className='schedule-icon' /> pepsi centre
                  </div>
                  <div>
                    <AiOutlineClockCircle className='schedule-icon' /> 40:00
                  </div>
        ...
        <h4 className='heading-tertiary'>For more info & enquires on speaker, contact:</h4>
        <div className='bookme-socials'>
          ...
          <div className='bookme-social-details'>
            ...
            <div>07 Bolanle Road, Off Ola Street, Lekki Phase 1, Lagos State. Nigeria</div>
          </div>
        </div>
