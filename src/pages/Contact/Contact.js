      ...
      <div className='row justify-content-center'>
        <div className='col-10 col-xl-4 col-lg-4 col-md-5 col-sm-10 col-xs-10 form-holder p-3 rounded-start shadow'>
          ...
          <form className='p-3 contactForm'>
            <p className='contactFormText'>We are here for you! How can we help?</p>

            <div className='form-group mb-3'>
              <label className='text-start justify-content-start contactLabel' htmlFor='fullname'>
                Fullname
              </label>
            ...
            <div className='form-group mb-3'>
              <label className='text-start justify-content-start contactLabel' htmlFor='email'>
                E-mail Adress
              </label>
            ...
            <div className='form-floating mb-3'>
              <textarea cols={10} className='form-control contactTextarea' name='message' />
              <label htmlFor='message' className='text-start justify-content-start contactLabel'>
                Type here
              </label>
            </div>

            <button className='btn btn-success d-block w-100  mt-5'>Submit</button>
          </form>
        </div>
